...
.PHONY: help aur build-all build-cli build-libs clean-all clean-cli clean-libs install-all install-cli install-libs
...
build-all: build-cli build-libs
...
clean-all: clean-cli clean-libs
...
install-all: install-libs install-cli
